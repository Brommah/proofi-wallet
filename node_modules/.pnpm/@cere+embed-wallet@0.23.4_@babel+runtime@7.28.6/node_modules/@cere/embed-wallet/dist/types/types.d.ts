...
export type ContextWhiteLabel = Record<string, any>;
export type Context = {
    banner?: ContextBanner;
    app: ContextApp;
    whiteLabel?: ContextWhiteLabel;
};
export type PartialContext = Omit<Context, 'app'> & {
    app?: Partial<ContextApp>;
};
...
export type WalletStatus = 'not-ready' | 'initializing' | 'ready' | 'connected' | 'connecting' | 'disconnecting' | 'errored';
