 ...
 * ```
 */
export declare class DDCClustersGovPallet {
    private apiPromise;
     ...
     * ```
     */
    proposeUpdateClusterProtocol(clusterId: ClusterId, protocolParams: ClusterProtocolParams, member: ClusterMember, nodePublicKey?: NodePublicKey): Sendable;
    /**
    ...
    private createClusterMember;
}
//# sourceMappingURL=DDCClustersGovPallet.d.ts.map