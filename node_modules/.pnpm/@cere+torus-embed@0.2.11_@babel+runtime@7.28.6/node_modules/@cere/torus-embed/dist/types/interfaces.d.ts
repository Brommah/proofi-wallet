...
export declare const TORUS_BUILD_ENV: {
    readonly CERE: "cere";
    readonly CERE_AWS: "cere-aws";
    readonly CERE_LEGACY: "cere-legacy";
    readonly CERE_DEV: "cere-dev";
    readonly CERE_STAGE: "cere-stage";
...
export declare const CERE_PROD_ENVS: TORUS_BUILD_ENV_TYPE[];
...
export declare type PopupMode = "modal" | "popup";
...
export declare type AuthType = "telegram-mini-app" | "other";
export interface AuthMethod {
    type: AuthType;
    token: string;
}
export declare type WalletMode = "default" | "light";
