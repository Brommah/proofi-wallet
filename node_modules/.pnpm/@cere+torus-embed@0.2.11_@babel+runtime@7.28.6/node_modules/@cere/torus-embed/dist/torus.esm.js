...
class Torus {
  constructor() {
    ...
    _defineProperty(this, "loginOptions", {});

    _defineProperty(this, "useWalletConnect", void 0);

    _defineProperty(this, "popupMode", "popup");
      ...
      if (chunk.name === "show_wallet_instance") {
        ...
        const _chunk$data = chunk.data,
          ...
          target
              ...
              extraParams = _objectWithoutProperties(_chunk$data, _excluded2);

        const finalUrl = new URL(`${this.torusUrl}/wallet${finalPath}`);
        Object.entries(_objectSpread(_objectSpread(_objectSpread({}, extraParams), params), {}, {
          instanceId
        })).forEach(_ref2 => {
...
export { BUTTON_POSITION, CERE_PROD_ENVS, LOGIN_PROVIDER, PAYMENT_PROVIDER, SUPPORTED_PAYMENT_NETWORK, TORUS_BUILD_ENV, TorusInpageProvider, WALLET_OPENLOGIN_VERIFIER_MAP, WALLET_VERIFIERS, Torus as default, preloadIframe };
