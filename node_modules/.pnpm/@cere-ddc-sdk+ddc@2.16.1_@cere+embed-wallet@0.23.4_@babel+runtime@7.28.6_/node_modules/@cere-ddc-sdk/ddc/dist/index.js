import { ServiceType, stackIntercept, RpcError, Deferred, ClientStreamingCall, RpcOutputStreamController, DuplexStreamingCall, mergeRpcOptions, UnaryCall, DeferredState } from '@protobuf-ts/runtime-rpc';
import base58 from 'bs58';
import { encodeAddress, decodeAddress, Web3Signer, createRandomSigner, StorageNodeMode } from '@cere-ddc-sdk/blockchain';
export { CereWalletSigner, JsonSigner, KeyringSigner, StorageNodeMode, UriSigner } from '@cere-ddc-sdk/blockchain';
...
import { json, arrayBuffer, text } from 'stream/consumers';
import { ChannelCredentials } from '@grpc/grpc-js';
import { GrpcTransport as GrpcTransport$1 } from '@protobuf-ts/grpc-transport';
...
class Signature$Type extends MessageType {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.algorithm !== 0) writer.tag(1, WireType.Varint).int32(message.algorithm);
    /* bytes signer = 2; */
    if (message.signer.length) writer.tag(2, WireType.LengthDelimited).bytes(message.signer);
    /* bytes value = 3; */
...
// @generated message type with reflection information, may provide speed optimized methods
class AuthToken$Type extends MessageType {
  constructor() {
    super("AuthToken", [{
      no: 1,
      name: "signature",
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.signature) Signature.internalBinaryWrite(message.signature, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    /* Payload payload = 2; */
    if (message.payload) Payload.internalBinaryWrite(message.payload, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Payload$Type extends MessageType {
    ...
    while (reader.pos < end) {
      ...
      switch (fieldNo) {
        ...
        case /* repeated Operation operations */5:
          if (wireType === WireType.LengthDelimited) for (let e = reader.int32() + reader.pos; reader.pos < e;) message.operations.push(reader.int32());else message.operations.push(reader.int32());
          break;
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.prev) AuthToken$1.internalBinaryWrite(message.prev, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    /* optional bytes subject = 2; */
    if (message.subject !== undefined) writer.tag(2, WireType.LengthDelimited).bytes(message.subject);
    /* optional bool canDelegate = 3; */
    if (message.canDelegate !== undefined) writer.tag(3, WireType.Varint).bool(message.canDelegate);
    /* optional uint64 bucketId = 4 [jstype = JS_NORMAL]; */
    if (message.bucketId !== undefined) writer.tag(4, WireType.Varint).uint64(message.bucketId);
    ...
    if (message.expiresAt !== undefined) writer.tag(6, WireType.Varint).int64(message.expiresAt);
    /* optional bytes pieceCid = 7; */
    if (message.pieceCid !== undefined) writer.tag(7, WireType.LengthDelimited).bytes(message.pieceCid);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class AuthToken {
  ...
  get subject() {
    ...
    return ((_this$token$payload = this.token.payload) == null ? void 0 : _this$token$payload.subject) && encodeAddress(this.token.payload.subject);
  }
  /**
  ...
  static maybeToken(token) {
    ...
    return this.fromProto(AuthToken$1.fromBinary(base58.decode(token)));
  }
  /**
  ...
  static fullAccess(params = {}) {
    return new AuthToken({
      ...params,
      operations: [Operation.GET, Operation.PUT, Operation.DELETE]
    });
  }
}
...
const createSdkSigner = async signer => {
  const randomSigner = createRandomSigner({
    type: signer.type
  });
    ...
    formatters: {
      log: mapLog(value => {
        if (value instanceof Uint8Array) {
          return '0x' + truncateHex(Buffer$1.from(value).toString('hex'));
        }
        return value;
      })
    }
...
/* eslint-disable */
// @generated message type with reflection information, may provide speed optimized methods
class PutRequest$Type$1 extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.bucketId !== 0n) writer.tag(1, WireType.Varint).uint64(message.bucketId);
    /* cns.Record record = 2; */
    if (message.record) Record.internalBinaryWrite(message.record, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
// @generated message type with reflection information, may provide speed optimized methods
class PutResponse$Type$1 extends MessageType {
  constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class GetRequest$Type$1 extends MessageType {
  constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class GetResponse$Type$1 extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    /* cns.Record record = 1; */
    if (message.record) Record.internalBinaryWrite(message.record, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Record$Type extends MessageType {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.signature) Signature.internalBinaryWrite(message.signature, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    /* bytes cid = 2; */
    if (message.cid.length) writer.tag(2, WireType.LengthDelimited).bytes(message.cid);
    /* string name = 3; */
    if (message.name !== "") writer.tag(3, WireType.LengthDelimited).string(message.name);
    /* optional uint32 ttl = 4; */
    if (message.ttl !== undefined) writer.tag(4, WireType.Varint).uint32(message.ttl);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
 ...
 */
const CnsApi$1 = new ServiceType("cns.CnsApi", [{
  name: "Put",
  options: {
    "google.api.http": {
...
// @generated message type with reflection information, may provide speed optimized methods
class ActivityRecord$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.upstream) ActivityFulfillment.internalBinaryWrite(message.upstream, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    /* repeated activity_report.ActivityFulfillment downstream = 2; */
    for (let i = 0; i < message.downstream.length; i++) ActivityFulfillment.internalBinaryWrite(message.downstream[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    /* uint64 timestamp = 3; */
    if (message.timestamp !== 0) writer.tag(3, WireType.Varint).uint64(message.timestamp);
    /* common.Signature signature = 10; */
    if (message.signature) Signature.internalBinaryWrite(message.signature, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
// @generated message type with reflection information, may provide speed optimized methods
class ActivityRequest$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.parentRequest) ActivityRequest.internalBinaryWrite(message.parentRequest, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    /* string requestId = 2; */
    ...
    if (message.requestType !== 0) writer.tag(3, WireType.Varint).int32(message.requestType);
    /* activity_report.ActivityRequest.ContentType contentType = 4; */
    if (message.contentType !== 0) writer.tag(4, WireType.Varint).int32(message.contentType);
    /* uint64 bucketId = 5 [jstype = JS_NORMAL]; */
    if (message.bucketId !== 0n) writer.tag(5, WireType.Varint).uint64(message.bucketId);
    /* bytes id = 6; */
    if (message.id.length) writer.tag(6, WireType.LengthDelimited).bytes(message.id);
    /* uint64 offset = 7; */
    if (message.offset !== 0) writer.tag(7, WireType.Varint).uint64(message.offset);
    /* uint64 size = 8; */
    if (message.size !== 0) writer.tag(8, WireType.Varint).uint64(message.size);
    /* uint64 timestamp = 9; */
    if (message.timestamp !== 0) writer.tag(9, WireType.Varint).uint64(message.timestamp);
    /* common.Signature signature = 10; */
    if (message.signature) Signature.internalBinaryWrite(message.signature, writer.tag(10, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
...
// @generated message type with reflection information, may provide speed optimized methods
class ActivityAcknowledgment$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.bytesStoredOrDelivered !== 0) writer.tag(2, WireType.Varint).uint64(message.bytesStoredOrDelivered);
    /* uint64 timestamp = 3; */
    if (message.timestamp !== 0) writer.tag(3, WireType.Varint).uint64(message.timestamp);
    /* common.Signature signature = 4; */
    if (message.signature) Signature.internalBinaryWrite(message.signature, writer.tag(4, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
// @generated message type with reflection information, may provide speed optimized methods
class ActivityFulfillment$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.request) ActivityRequest.internalBinaryWrite(message.request, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    /* optional activity_report.ActivityAcknowledgment ack = 2; */
    if (message.ack) ActivityAcknowledgment.internalBinaryWrite(message.ack, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
const createActivityRequest = async (request, {
  ...
  return Buffer$1.from(ActivityRequest.toBinary(activityRequest)).toString('base64');
};
/**
 * Generates a unique request ID.
 */
const createRequestId = () => v4();
...
const createRpcMeta = (correlationId, meta) => {
  return {
    ...meta,
    [CORRELATION_ID_META_KEY]: correlationId || v4()
  };
};
...
class CnsApi {
  ...
  async getRecord({
    ...
    try {
       ...
       */
      const isNotFound = error instanceof RpcError && error.code === GrpcStatus[GrpcStatus.UNKNOWN] && error.message === 'no result'; // error.code === GrpcStatus[GrpcStatus.NOT_FOUND];
      if (!isNotFound) {
        throw error;
      }
    }
...
/* eslint-disable */
// @generated message type with reflection information, may provide speed optimized methods
class PutRequest$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.bucketId !== 0n) writer.tag(1, WireType.Varint).uint64(message.bucketId);
    /* dag.Node node = 2; */
    if (message.node) Node.internalBinaryWrite(message.node, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    /* optional bytes cid = 3; */
    if (message.cid !== undefined) writer.tag(3, WireType.LengthDelimited).bytes(message.cid);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
// @generated message type with reflection information, may provide speed optimized methods
class PutResponse$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    /* bytes cid = 1; */
    if (message.cid.length) writer.tag(1, WireType.LengthDelimited).bytes(message.cid);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class GetRequest$Type extends MessageType {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.path !== undefined) writer.tag(3, WireType.LengthDelimited).string(message.path);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class GetResponse$Type extends MessageType {
  ...
  internalBinaryWrite(message, writer, options) {
    /* dag.Node node = 1; */
    if (message.node) Node.internalBinaryWrite(message.node, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
class Node$Type extends MessageType {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    for (let i = 0; i < message.links.length; i++) Link$1.internalBinaryWrite(message.links[i], writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    /* repeated dag.Tag tags = 3; */
    for (let i = 0; i < message.tags.length; i++) Tag$1.internalBinaryWrite(message.tags[i], writer.tag(3, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
// @generated message type with reflection information, may provide speed optimized methods
class Link$Type extends MessageType {
  constructor() {
    super("dag.Link", [{
      no: 1,
      name: "cid",
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.name !== "") writer.tag(2, WireType.LengthDelimited).string(message.name);
    /* uint64 size = 3; */
    if (message.size !== 0) writer.tag(3, WireType.Varint).uint64(message.size);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
 ...
 */
const DagApi$1 = new ServiceType("dag.DagApi", [{
  name: "Put",
  options: {
    "google.api.http": {
...
class CidValidator {
  ...
  async getHasher() {
    this.hasherPromise || (this.hasherPromise = createBLAKE3());
...
const withChunkSize = chunkSize => {
  ...
  return new TransformStream({
    transform(data, controller) {
      buffer = buffer ? Buffer$1.concat([buffer, data]) : Buffer$1.from(data);
      while (buffer.byteLength >= chunkSize) {
        controller.enqueue(slice.call(buffer, 0, chunkSize));
        buffer = Buffer$1.from(slice.call(buffer, chunkSize));
      }
    },
    flush(controller) {
      var _buffer;
      if ((_buffer = buffer) != null && _buffer.byteLength) {
...
/* eslint-disable */
// @generated message type with reflection information, may provide speed optimized methods
class PutRawPieceRequest$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.body.oneofKind === "metadata") PutRawPieceRequest_Metadata.internalBinaryWrite(message.body.metadata, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    /* file.PutRawPieceRequest.Content content = 2; */
    if (message.body.oneofKind === "content") PutRawPieceRequest_Content.internalBinaryWrite(message.body.content, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
// @generated message type with reflection information, may provide speed optimized methods
class PutRawPieceRequest_Metadata$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.cid !== undefined) writer.tag(2, WireType.LengthDelimited).bytes(message.cid);
    /* optional uint64 offset = 3; */
    if (message.offset !== undefined) writer.tag(3, WireType.Varint).uint64(message.offset);
    /* bool isMultipart = 4; */
    if (message.isMultipart !== false) writer.tag(4, WireType.Varint).bool(message.isMultipart);
    /* uint64 size = 5; */
    if (message.size !== 0) writer.tag(5, WireType.Varint).uint64(message.size);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
// @generated message type with reflection information, may provide speed optimized methods
class PutRawPieceRequest_Content$Type extends MessageType {
  constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class PutRawPieceResponse$Type extends MessageType {
  constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class PutMultiPartPieceRequest$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.cid !== undefined) writer.tag(2, WireType.LengthDelimited).bytes(message.cid);
    /* uint64 totalSize = 3; */
    if (message.totalSize !== 0) writer.tag(3, WireType.Varint).uint64(message.totalSize);
    /* uint64 partSize = 4; */
    if (message.partSize !== 0) writer.tag(4, WireType.Varint).uint64(message.partSize);
    /* repeated bytes partHashes = 5; */
    for (let i = 0; i < message.partHashes.length; i++) writer.tag(5, WireType.LengthDelimited).bytes(message.partHashes[i]);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
// @generated message type with reflection information, may provide speed optimized methods
class PutMultiPartPieceResponse$Type extends MessageType {
  constructor() {
...
// @generated message type with reflection information, may provide speed optimized methods
class GetFileRequest$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.body.oneofKind === "request") GetFileRequest_Request.internalBinaryWrite(message.body.request, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    /* activity_report.ActivityAcknowledgment ack = 2; */
    if (message.body.oneofKind === "ack") ActivityAcknowledgment.internalBinaryWrite(message.body.ack, writer.tag(2, WireType.LengthDelimited).fork(), options).join();
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
// @generated message type with reflection information, may provide speed optimized methods
class GetFileRequest_Request$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.bucketId !== 0n) writer.tag(2, WireType.Varint).uint64(message.bucketId);
    /* optional file.GetFileRequest.Request.Range range = 3; */
    if (message.range) GetFileRequest_Request_Range.internalBinaryWrite(message.range, writer.tag(3, WireType.LengthDelimited).fork(), options).join();
    /* bool authenticate = 4; */
    if (message.authenticate !== false) writer.tag(4, WireType.Varint).bool(message.authenticate);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
// @generated message type with reflection information, may provide speed optimized methods
class GetFileRequest_Request_Range$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    /* uint64 start = 1; */
    if (message.start !== 0) writer.tag(1, WireType.Varint).uint64(message.start);
    /* uint64 end = 2; */
    if (message.end !== 0) writer.tag(2, WireType.Varint).uint64(message.end);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
// @generated message type with reflection information, may provide speed optimized methods
class GetFileResponse$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    if (message.body.oneofKind === "proof") GetFileResponse_Proof.internalBinaryWrite(message.body.proof, writer.tag(1, WireType.LengthDelimited).fork(), options).join();
    /* bytes data = 2; */
    if (message.body.oneofKind === "data") writer.tag(2, WireType.LengthDelimited).bytes(message.body.data);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
...
// @generated message type with reflection information, may provide speed optimized methods
class GetFileResponse_Proof$Type extends MessageType {
  constructor() {
  ...
  internalBinaryWrite(message, writer, options) {
    ...
    for (let i = 0; i < message.proof.length; i++) writer.tag(1, WireType.LengthDelimited).bytes(message.proof[i]);
    let u = options.writeUnknownFields;
    if (u !== false) (u == true ? UnknownFieldHandler.onWrite : u)(this.typeName, message, writer);
    return writer;
  }
 ...
 */
const FileApi$1 = new ServiceType("file.FileApi", [{
  name: "putRawPiece",
...
class TimeoutAbortController extends AbortController {
  constructor(timeout) {
    ...
    this.start = () => {
      this.stop();
      this.timeoutHandle = setTimeout(() => this.abort(new RpcError('Request timed out', GrpcStatus[GrpcStatus.CANCELLED])), this.timeout);
      return this;
    };
 ...
 * @group RPC Transport
 */
class GrpcTransport extends GrpcTransport$1 {
  constructor({
    grpcUrl,
    interceptors = [],
    timeout
...
class WebsocketTransport {
  ...
  clientStreaming(method, options) {
    ...
    return new ClientStreamingCall(method, (_options$meta = options.meta) != null ? _options$meta : {}, inputStream, defHeader.promise, defMessage.promise, defStatus.promise, defTrailer.promise);
  }
  duplex(method, options) {
    ...
    return new DuplexStreamingCall(method, (_options$meta2 = options.meta) != null ? _options$meta2 : {}, inputStream, defHeader.promise, outStream, defStatus.promise, defTrailer.promise);
  }
  ...
  unary(method, input, options) {
    ...
    const request = new Promise((onEnd, reject) => {
      ...
      if (options.abort) {
        options.abort.addEventListener('abort', () => {
          var _options$abort;
          reject(((_options$abort = options.abort) == null ? void 0 : _options$abort.reason) || new RpcError('Canceled by client', GrpcStatus[GrpcStatus.CANCELLED]));
          client.close();
        });
      }
    });
    ...
    return new UnaryCall(method, (_options$meta3 = options.meta) != null ? _options$meta3 : {}, input, defHeader.promise, defMessage.promise, defStatus.promise, defTrailer.promise);
  }
}
...
class DagNode {
  constructor(data, links = [], tags = []) {
     ...
     */
    this.tags = void 0;
    this.dataBuffer = Buffer$1.from(data || []);
    this.links = links;
    this.tags = tags;
  }
  /**
...
const priorityMap = {
  [RouterOperation.READ_DAG_NODE]: {
    [StorageNodeMode.Full]: 1,
    [StorageNodeMode.Cache]: 1,
    [StorageNodeMode.Storage]: 2
  },
  [RouterOperation.STORE_DAG_NODE]: {
    [StorageNodeMode.Full]: 1,
    [StorageNodeMode.Storage]: 2,
    [StorageNodeMode.Cache]: undefined // Not applicable for the operation
  },
  ...
  [RouterOperation.STORE_CNS_RECORD]: {
    [StorageNodeMode.Full]: 1,
    [StorageNodeMode.Storage]: 2,
    [StorageNodeMode.Cache]: undefined // Not applicable for the operation
  }
...
class PingStrategy extends NodeTypeStrategy {
  ...
  async ping(record) {
    ...
    try {
      const response = await fetch$1(pingUrl, {
        cache: 'no-cache',
...
class NodeError extends RpcError {
  constructor(...args) {
    super(...args);
...
class BalancedNode {
  ...
  async readPiece(bucketId, cidOrName, readOptions = {}) {
    ...
    return this.withRetry(bucketId, RouterOperation.READ_PIECE, options, node => node.readPiece(bucketId, cidOrName, options));
  }
  async storeDagNode(bucketId, dagNode, storeOptions = {}) {
    const options = withCorrelationId(storeOptions);
    return this.withRetry(bucketId, RouterOperation.STORE_DAG_NODE, options, node => node.storeDagNode(bucketId, dagNode, options));
  }
  async getDagNode(bucketId, cidOrName, getOptions = {}) {
    const options = withCorrelationId(getOptions);
    return this.withRetry(bucketId, RouterOperation.READ_DAG_NODE, options, node => node.getDagNode(bucketId, cidOrName, options));
  }
  async storeCnsRecord(bucketId, record, storeOptions = {}) {
    const options = withCorrelationId(storeOptions);
    return this.withRetry(bucketId, RouterOperation.STORE_CNS_RECORD, options, node => node.storeCnsRecord(bucketId, record, options));
  }
  async getCnsRecord(bucketId, name, getOptions = {}) {
    const options = withCorrelationId(getOptions);
    return this.withRetry(bucketId, RouterOperation.READ_CNS_RECORD, options, node => node.getCnsRecord(bucketId, name, options));
  }
  async resolveName(bucketId, cidOrName, resolveOptions = {}) {
    const options = withCorrelationId(resolveOptions);
    return this.withRetry(bucketId, RouterOperation.READ_CNS_RECORD, options, node => node.resolveName(bucketId, cidOrName, options));
  }
}
...
export { ActivityAcknowledgment, ActivityRequest, AuthToken, Operation as AuthTokenOperation, BalancedNode, Cid, CnsApi, CnsRecord, CnsRecordResponse, DEFAULT_PRESET, DEVNET, DEVNET_STATIC, DagApi, DagNode, DagNodeResponse, FileApi, GrpcTransport, KB, Link, MAINNET, MAX_PIECE_SIZE, MB, MIN_PIECE_SIZE, MultipartPiece, NodeError, Piece, PieceResponse, Router, RouterOperation, StorageNode, TESTNET, TESTNET_STATIC, Tag, WebsocketTransport, bindErrorLogger, createContentStream, createCorrelationId, createLogger, isContentStream, consumers as streamConsumers, withChunkSize };
