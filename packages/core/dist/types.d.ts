...
export declare const KEY_TYPE_NAMESPACE: Record<KeyType, ChainNamespace>;
/** Purpose tag for scoped signing */
export type SigningPurpose = 'transaction' | 'credential' | 'authentication' | 'encryption' | (string & {});
