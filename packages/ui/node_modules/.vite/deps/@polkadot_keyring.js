...
// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/packageInfo.js
var packageInfo3 = { name: "@polkadot/keyring", path: import.meta && import.meta.url ? new URL(import.meta.url).pathname.substring(0, new URL(import.meta.url).pathname.lastIndexOf("/") + 1) : "auto", type: "esm", version: "14.0.1" };

// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/packageDetect.js
detectPackage(packageInfo3, null, [packageInfo2, packageInfo]);

// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/pair/defaults.js
...
// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/pair/decode.js
...
// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/pair/encode.js
...
// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/pair/toJson.js
...
// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/pair/index.js
...
// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/defaults.js
...
// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/pairs.js
var _map;
var Pairs = class {
  constructor() {
  ...
  add(pair2) {
    __privateGet(this, _map)[decodeAddress(pair2.address).toString()] = pair2;
    return pair2;
  }
  all() {
  ...
  get(address2) {
    const pair2 = __privateGet(this, _map)[decodeAddress(address2).toString()];
    if (!pair2) {
  ...
  remove(address2) {
    delete __privateGet(this, _map)[decodeAddress(address2).toString()];
  }
};
_map = new WeakMap();

// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/keyring.js
var PairFromSeed = {
...
var Keyring = class {
  constructor(options = {}) {
    ...
    __publicField(this, "encodeAddress", (address2, ss58Format) => {
      return this.type === "ethereum" ? ethereumEncode(address2) : encodeAddress(address2, ss58Format ?? __privateGet(this, _ss58));
    });
   ...
   */
  addPair(pair2) {
    return __privateGet(this, _pairs).add(pair2);
  }
  /**
   * @name addFromAddress
   ...
   */
  addFromUri(suri, meta2 = {}, type = this.type, wordlist) {
    return this.addPair(this.createFromUri(suri, meta2, type, wordlist));
  }
  /**
   * @name createFromJson
   ...
   */
  createFromUri(_suri, meta2 = {}, type = this.type, wordlist) {
   ...
   */
  getPair(address2) {
    return __privateGet(this, _pairs).get(address2);
  }
  /**
   * @name getPairs
   ...
   */
  removePair(address2) {
    __privateGet(this, _pairs).remove(address2);
  }
  /**
   * @name setSS58Format;
  ...
  toJson(address2, passphrase) {
    return __privateGet(this, _pairs).get(address2).toJson(passphrase);
  }
};
_pairs = new WeakMap();
_type = new WeakMap();
...
// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/testing.js
var PAIRSSR25519 = [
  {
...
// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/pair/nobody.js
...
// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/testingPairs.js
...
// ../../node_modules/.pnpm/@polkadot+keyring@14.0.1_@polkadot+util-crypto@14.0.1_@polkadot+util@14.0.1__@polkadot+util@14.0.1/node_modules/@polkadot/keyring/index.js
...
export {
  ...
  createTestPairs,
  decodeAddress,
  keyring_default as default,
  encodeAddress,
  packageInfo3 as packageInfo,
  setSS58Format
};
//# sourceMappingURL=@polkadot_keyring.js.map
